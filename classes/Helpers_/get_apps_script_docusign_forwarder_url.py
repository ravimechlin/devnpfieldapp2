@staticmethod
def get_apps_script_docusign_forwarder_url():
    keyy = "apps_script_url_for_docusign_forwarder"
    val = memcache.get(keyy)

    if val is None:
        bucket_name = os.environ.get('BUCKET_NAME', app_identity.get_default_gcs_bucket_name())
        bucket = "/" + bucket_name
        filename = bucket + "/ApplicationSettings/apps_script_docusign_forwarder.url"
