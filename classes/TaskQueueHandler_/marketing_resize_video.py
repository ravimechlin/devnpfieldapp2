def marketing_resize_video(self):
    ...
    post_payload["size"] = "1280x720"
    if aspect == "portrait":
        post_payload["size"] = "720x1280"
    post_payload["skip"] = {"max_duration": 30}
    post_payload["outputs"] = [{}]
    post_payload["outputs"][0]["size"] = post_payload["size"]
    post_payload["outputs"][0]["audio_bitrate"] = 30
    post_payload["outputs"][0]["max_video_bitrate"] = 600
    post_payload["outputs"][0]["h264_profile"] = "main"
    post_payload["outputs"][0]["h264_level"] = "3.1"
    post_payload["outputs"][0]["max_frame_rate"] = 30
    post_payload["outputs"][0]["format"] = "3gp"
