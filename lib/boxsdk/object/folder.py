...
class Folder(Item):
    ...
    def add_collaborator(self, collaborator, role, resp_obj_dict, notify=False):
        ...
        resp_obj_dict = collaboration_response
        collab_id = collaboration_response['id']
        ret_collaboration = Collaboration(
            session=self._session,
            object_id=collab_id,
            response_object=collaboration_response,
        )
        ret_collaboration.set_resp_dct(resp_obj_dict)
        return ret_collaboration
